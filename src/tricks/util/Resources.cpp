...
ofTrueTypeFont *tricks::util::Resources::font = NULL;
bool tricks::util::Resources::customFontNotAvailable = false;
map<string,ofImage*> tricks::util::Resources::images;

ofImage *tricks::util::Resources::getImage(string path) {
...
void tricks::util::Resources::drawString(string str, int x, int y) {
